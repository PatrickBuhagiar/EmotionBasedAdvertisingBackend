...
public class Application {
    ...
    private void init() {
        ...
        repository.save(new Advert(3L, "Heinz Advert", AgeGroup.TEEN, Emotion.NEUTRAL, Gender.ALL, "https://i.pinimg.com/736x/df/aa/31/dfaa3199b461cf2f5ee75afab66f37c6--advertising-design-advertising-campaign.jpg", 0));
